...
import type { ProviderAuthResponse } from '@/lib/types/provider';
...
export default function VerifyPage() {
  ...
  // Focus next input on digit entry; focus prev on backspace
  ...
  const handleVerify = async (code: string) => {
    ...
    try {
      ...
      // Fetch provider profile to populate sources
      const provider = await api.get<ProviderAuthResponse['provider']>('/provider/auth/me');
